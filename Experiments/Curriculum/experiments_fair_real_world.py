...
def main_fair_real_world(num_threads=-1):
    ...
    ## Real World Data
    experiment = ExperimentMain(Path('Reproduce/Configs/main_config_fair_real_world_curriculum.yml'))
    ...
    experiment = ExperimentMain(Path('Reproduce/Configs/main_config_fair_real_world_anti_curriculum.yml'))
    experiment.ExperimentPreprocessing(num_threads=num_threads)
    experiment.GridSearch(num_threads=num_threads)
    experiment.EvaluateResults()
    experiment.RunBestModel(num_threads=num_threads)
    ...
    experiment = ExperimentMain(Path('Reproduce/Configs/main_config_fair_real_world_curriculum_edges.yml'))
    experiment.ExperimentPreprocessing(num_threads=num_threads)
    experiment.GridSearch(num_threads=num_threads)
    experiment.EvaluateResults()
    experiment.RunBestModel(num_threads=num_threads)
    ...
    experiment = ExperimentMain(Path('Reproduce/Configs/main_config_fair_real_world_anti_curriculum_edges.yml'))
    experiment.ExperimentPreprocessing(num_threads=num_threads)
    experiment.GridSearch(num_threads=num_threads)
    experiment.EvaluateResults()
    experiment.RunBestModel(num_threads=num_threads)
