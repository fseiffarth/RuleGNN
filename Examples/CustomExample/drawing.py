...
def main():
    ...
    network_config_file = 'Examples/CustomExample/Configs/config_experiment.yml'
    graph_ids = [0, 1, 2]
    ww = WeightVisualization(db_name=db_name, main_config=main_config_file, experiment_config=network_config_file)
